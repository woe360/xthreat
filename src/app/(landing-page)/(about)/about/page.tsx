...
//       <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-56 mb-20">
//         {/* Hero Section */}
//         <motion.div
//           initial={{ opacity: 0, y: -20 }}
//           animate={{ opacity: 1, y: 0 }}
...
//                 animate={{ opacity: 1, y: 0 }}
//                 transition={{ duration: 0.5 }}
//                 className="text-5xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500 font-semibold pb-1  mb-12 "
//               >
//                 Our Story
//               </motion.h2>
//               <motion.div 
...
//         >
//           <h2 className="text-3xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500 font-semibold pb-1  mb-4">Ready to strengthen your cybersecurity posture?</h2>
...
// 'use client'
// import React from 'react';
// import { Shield, Brain, Zap, Target, Users } from 'lucide-react';
// import { motion } from 'framer-motion';
// import { Card, CardContent } from '@/components/global/ui/card';
// import Navbar from '@/app/(landing-page)/navigation/navbar';
// import Footer from '@/app/(landing-page)/navigation/footer';
...
//           className="mb-20"
//         >
//           <h2 className="text-3xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500 font-semibold pb-1 mb-8 text-center">
//             Join Our Team
//           </h2>
...
//               Are you passionate about cybersecurity and want to make a difference? We're always looking for talented individuals to join our mission of making the digital world safer.
//             </p>
//             <motion.button
//               whileHover={{ scale: 1.05 }}
//               whileTap={{ scale: 0.95 }}
...
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.5 }}
//             className="text-4xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500 font-semibold pb-1 mb-12 text-center"
//           >
//             Our Story
//           </motion.h2>
...
//             >
//               <p>
//               At XThreat, we recognized a critical gap in cybersecurity awareness: human error. Even with the most advanced security systems, employees can still be the weakest link—or the strongest defense. This realization drives our mission to transform the way organizations approach security education.
//               </p>
//               <p>
//               Our goal is simple: help businesses prevent financial and reputational damage by empowering their teams with the knowledge and tools needed to recognize and respond to cyber threats. We've navigated the complex landscape of cybersecurity data, simplifying it to offer clear, effective solutions.              </p>
//             </motion.div>
//             <motion.div 
//               initial={{ opacity: 0, x: 20 }}
//               animate={{ opacity: 1, x: 0 }}
...
//             >
//               <p>
//                 XThreat is more than just a training platform; it's our way of sharing our knowledge and experience. We've designed our interactive quizzes and adaptive learning paths to ensure cybersecurity teams have the right information and tools for better decision making.
//               </p>
//               <p>
//                 By focusing on engaging, practical training, we're turning employees from potential vulnerabilities into active defenders of their organization's digital assets. Our mission is to create a world where every employee is empowered to be a cybersecurity champion.
//               </p>
//             </motion.div>
//           </div>
//         </section>
...
//             className="text-lg mb-12 max-w-3xl mx-auto text-center text-gray-300"
//           >
//         We have seen how overwhelming and complex cybersecurity training can be, especially for organizations without dedicated teams. At XThreat, we believe in simplifying this process, delivering clear, practical training that does not just educate it transforms how businesses handle cyber threats.          </motion.p>
//         </section>

//         {/* Unique Approaches Section */}
//         <section className="mb-20">
//           <motion.h2 
//             {...fadeInUp}
//             className="text-3xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500 font-semibold pb-1 mb-8 text-center"
...
//                     <approach.icon className="h-12 w-12 text-blue-500 mb-4" />
...
// 'use client'
// import React from 'react';
// import { Shield, Brain, Zap, Target, Users, TrendingUp, Lock, UserCheck, ChevronRight } from 'lucide-react';
// import { motion } from 'framer-motion';
// import { Card, CardContent } from '@/components/global/ui/card';
// import Navbar from '@/app/(landing-page)/navigation/navbar';
// import Footer from '@/app/(landing-page)/navigation/footer';
...
//   const approaches = [
//     { icon: Brain, title: "Interactive Quizzes", desc: "Engage your team with dynamic, scenario-based learning" },
//     { icon: Zap, title: "Adaptive Learning Paths", desc: "Personalized training journeys for optimal knowledge retention" },
//     { icon: Target, title: "Real-world Simulations", desc: "Prepare your employees for actual cyber threats" },
//   ];
...
//             {...fadeInUp}
//             transition={{ delay: 0.2 }}
//             className="text-lg mb-12 max-w-3xl mx-auto text-gray-300 space-y-6"
//           >
//             <p>
...
//                 >
//                   <ChevronRight className="h-6 w-6 text-blue-500 mr-2 flex-shrink-0 mt-1" />
//                   <p>{challenge}</p>
//                 </motion.div>
//               ))}
//             </div>
...
//                 <impact.icon className="h-12 w-12 text-blue-500 mb-4 mx-auto" />
//                 <h3 className="text-xl font-semibold mb-2">{impact.title}</h3>
//                 <p className="text-3xl font-bold text-blue-400 mb-2">{impact.value}</p>
...
//         >
//           <h2 className="text-3xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500 font-semibold pb-1 mb-4">Ready to strengthen your cybersecurity posture?</h2>
//           <p className="mb-6 text-gray-400">Join us in creating a world where every employee is a cybersecurity champion. Let's turn your team into your most powerful cybersecurity asset.</p>
//           <motion.button
//             whileHover={{ scale: 1.05 }}
//             whileTap={{ scale: 0.95 }}
//             className="inline-flex items-center px-6 py-3 border border-gray-600 text-base font-medium rounded-xl shadow-sm text-black bg-gray-200 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
...
//               >
//                 <div className="bg-blue-500 rounded-full p-4 mr-6">
...
//             ))}
//           </div>
//           <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-500 rounded-full opacity-10 filter blur-3xl"></div>
//         </section>
...
//       <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-56 mb-21">
//         {/* Hero Section */}
//         <motion.div
//           initial={{ opacity: 0, y: -20 }}
//           animate={{ opacity: 1, y: 0 }}
...
//                     activeChallenge === index ? 'bg-blue-900 bg-opacity-50' : 'hover:bg-gray-700'
//                   }`}
//                   onClick={() => setActiveChallenge(activeChallenge === index ? null : index)}
//                 >
//                   <Shield className={`h-6 w-6 mr-3 flex-shrink-0 transition-colors duration-300 ${
//                     activeChallenge === index ? 'text-blue-400' : 'text-blue-600'
//                   }`} />
...
//             transition={{ delay: 0.2 }}
//             >
//             <div className="absolute inset-0 bg-blue-500 rounded-full opacity-10 filter blur-3xl"></div>
//             <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
//               <circle cx="200" cy="200" r="140" fill="none" stroke="#374151" strokeWidth="2" />
//               {approaches.map((approach, index) => {
//                 const angle = (index / approaches.length) * 2 * Math.PI - Math.PI / 2;
//                 const x = 200 + 140 * Math.cos(angle);
//                 const y = 200 + 140 * Math.sin(angle);
//                 return (
//                   <g key={index}>
//                     <circle cx={x} cy={y} r="60" fill="#1F2937" />
//                     <foreignObject x={x - 50} y={y - 50} width="100" height="100">
//                       <div className="h-full flex flex-col items-center justify-center text-center p-2">
//                         <h3 className="text-xs font-semibold mb-1">{approach.title}</h3>
//                         <p className="text-[10px] text-gray-400">{approach.desc}</p>
//                       </div>
//                     </foreignObject>
//                   </g>
//                 );
...
//           >
//             {impacts.map((impact, index) => (
//               <div key={index} className="bg-gray-800/50 border border-gray-800 rounded-lg p-6 text-center">
...
//           className="text-center"
//         >
//           <h2 className="text-3xl bg-clip-text mt-48 text-transparent bg-gradient-to-b from-white to-neutral-500 font-semibold pb-1 mb-4">Ready to strengthen your cybersecurity posture?</h2>
//           <p className="mb-6 text-gray-400">Join us in creating a world where every employee is a cybersecurity champion. Let's turn your team into your most powerful cybersecurity asset.</p>
//           <motion.button
//             whileHover={{ scale: 1.05 }}
//             whileTap={{ scale: 0.95 }}
        ...
        <section className="mb-20">
          ...
          <div className="relative w-full h-[640px]">
            <motion.div
              ...
              transition={{ delay: 0.2 }}
            >
              <div className="absolute inset-0 bg-gray-800 rounded-full opacity-10 filter blur-3xl"></div>
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
                <circle cx="200" cy="200" r="140" fill="none" stroke="#374151" strokeWidth="2" />
                {approaches.map((approach, index) => {
                  const angle = (index / approaches.length) * 2 * Math.PI - Math.PI / 2;
                  ...
                  return (
                    <g key={index}>
                      ...
                      <foreignObject x={x - 50} y={y - 50} width="100" height="100">
                        <div className="h-full flex flex-col items-center justify-center text-center p-2">
                          <h3 className="text-xs font-semibold mb-1 text-white">{approach.title}</h3>
                          <p className="text-[10px] text-gray-400">{approach.desc}</p>
                        </div>
                      </foreignObject>
                    </g>
