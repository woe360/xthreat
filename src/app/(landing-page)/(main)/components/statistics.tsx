...
// // New separate component for individual statistic items
// const StatisticItem: React.FC<{
//   stat: StatisticItem;
//   index: number;
//   totalItems: number;
// }> = ({ stat, index, totalItems }) => {
//   const count = useGlitchingCountUp(stat.value, 3, stat.specialCount);
//   const divisorCount = stat.unit === '/ 3' ? useGlitchingCountUp(3, 3) : null;
...
//               <>
//                 <span>&nbsp;</span>/
//                 <span className="inline-block ml-2">{divisorCount}</span>
//               </>
//             ) : stat.unit}
//           </span>
//         )}
