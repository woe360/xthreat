...
const Icons = {
  ...
  dataBreach: () => (
    ...
    >
      ...
      <path d="M12 0C5.37 0 0 5.37 0 12c0 6.63 5.37 12 12 12s12-5.37 12-12S18.63 0 12 0zm5 17.5H7v-1h10v1zm0-4H7v-1h10v1zm0-4H7V8h10v1z" fill="#FF5252"/>
    </svg>
  ),
  phishingAttack: () => (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M20 4h-8L9 0H4C2.9 0 2 0.9 2 2v20c0 1.1 0.9 2 2 2h16c1.1 0 2-0.9 2-2V6c0-1.1-0.9-2-2-2zM4 2h4l3 4h9v16H4V2zm8 14h-2v-2h2v2zm0-4h-2V8h2v4z" fill="#03A9F4"/>
      <path d="M18 8h-6l-1-1H7v10h10V8z" fill="#2196F3"/>
    </svg>
  )
  ,
  ransomware: () => (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17v-2h2v2h-2zm1-4c-1.65 0-3-1.35-3-3h-2c0 2.76 2.24 5 5 5v2h2v-2c2.76 0 5-2.24 5-5h-2c0 1.65-1.35 3-3 3z" fill="#FFEB3B"/>
      <path d="M13 8h-2v2h2V8zm0 3h-2v2h2v-2z" fill="#FFC107"/>
    </svg>
  )
  ,
  insiderThreat: () => (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M12 2C9.24 2 7 4.24 7 7s2.24 5 5 5 5-2.24 5-5S14.76 2 12 2zm0 8c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3zm-7 9c0-2.67 5.33-4 7-4s7 1.33 7 4v2H5v-2zm2.22-1h9.56C15.33 16.67 13 15 12 15s-3.33 1.67-4.78 3z" fill="#673AB7"/>
      <path d="M12 7c-1.1 0-2 0.9-2 2s0.9 2 2 2 2-0.9 2-2-0.9-2-2-2z" fill="#9C27B0"/>
    </svg>
  )
  ,  
};
