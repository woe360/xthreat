...
interface ComponentWithAnimation {
  delay: number;
}

interface ProcessStepProps extends ComponentWithAnimation {
  icon: React.ReactNode;
  title: string;
  description: string;
}

interface WeakPointCardProps extends ComponentWithAnimation {
  icon: React.ReactNode;
  title: string;
  description: string;
}
...
// // Animation Constants
// const fadeInUp: AnimationConfig = {
...
//     delay: 0.4
//   },
//   // ... rest of the process steps data
// ];
...
//     delay: 0.8
//   },
//   // ... rest of the weak points data
// ];

// const benefitsData: string[] = [
//   "Customized security training tailored to your organization's specific vulnerabilities",
//   // ... rest of the benefits data
// ];
...
//           {/* Rest of the sections remain the same, just spread animation props explicitly */}
//           <motion.section 
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             transition={{ delay: 0.3, duration: 0.5 }}
