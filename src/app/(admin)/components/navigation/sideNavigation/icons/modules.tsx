...
//         rx="3"
//         className={clsx(
//           'dark:group-hover:fill-[#cbbf62] transition-all dark:fill-[#353346] fill-[#BABABB] group-hover:fill-[#FFD700]',
...
//         className={clsx(
//           'dark:group-hover:fill-[#edd873] transition-all dark:fill-[#C0BFC4] fill-[#5B5966] group-hover:fill-[#FFFACD]',
...
//         className={clsx(
//           'dark:group-hover:fill-[#d0bb4e] transition-all dark:fill-[#C0BFC4] fill-[#5B5966] group-hover:fill-[#FFFACD]',
//           { 'dark:!fill-[#FFD700] fill-[#FFFACD] ': selected }
//         )}
//       />
//       <path
  ...
  return (
    ...
    >
      <rect
        ...
        rx="3"
        className={clsx(
          'dark:group-hover:fill-[#5c5b62] transition-all dark:fill-[#353346] fill-[#BABABB] group-hover:fill-[#A0A0A0]',
      ...
      <path
        d="M14 3C14 1.89543 13.1046 1 12 1C10.8954 1 10 1.89543 10 3H8V5C8 5.55228 8.44772 6 9 6H15C15.5523 6 16 5.55228 16 5V3H14Z"
        className={clsx(
          'dark:group-hover:fill-[#c5c5d2] transition-all dark:fill-[#C0BFC4] fill-[#5B5966] group-hover:fill-[#CCCCCC]',
          { 'dark:!fill-[#363535] fill-[#CCCCCC]': selected }
        )}
      />
      <path
        fillRule="evenodd"
        ...
        className={clsx(
          'dark:group-hover:fill-[#9f9fa4] transition-all dark:fill-[#C0BFC4] fill-[#5B5966] group-hover:fill-[#CCCCCC]',
          { 'dark:!fill-[#a3a3a8] fill-[#CCCCCC]': selected }
        )}
      />
      <path
        fillRule="evenodd"
        ...
        className={clsx(
          'dark:group-hover:fill-[#C0BFC4] transition-all dark:fill-[#353346] fill-[#BABABB] group-hover:fill-[#A0A0A0]',
          { 'dark:!fill-[#C0BFC4] fill-[#A0A0A0]': selected }
        )}
      />
    </svg>
  );
