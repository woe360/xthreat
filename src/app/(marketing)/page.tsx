...
//                         <Link className="flex font-sans font-normal flex-row"
//                           href="/ai-training">
...
const Home: React.FC = () => {
  ...
  return (
    <main className="relative">
      ...
      <section className="flex flex-col font-sans relative z-20 md:mt-[30px] lg:mt-[32px] mb-10 mx-auto">
        <div>
          <h2 className="text-4xl md:text-5xl mb-2 pb-1 text-center bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-semibold">
            Why we exist
          </h2>
      ...
      <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.6 }}
          className="mt-28 px-6 sm:px-6 lg:px-8 mb-72 text-center"
        >
          <div className="bg-gray-900/30 [box-shadow:0_-20px_70px_-20px_#ffffff1f_inset] border border-gray-800 rounded-xl p-12 max-w-7xl mx-auto">
            ...
            <p className="text-gray-400 mb-8  font-serif italic text-lg sm:text-xl md:text-xl">
              Every 39 seconds, a business is attacked.
            </p>  
