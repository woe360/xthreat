...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[300px] w-full items-center justify-center overflow-hidden rounded-lg p-10 md:shadow-xl"
      ref={containerRef}
    >
      <div className="flex size-full flex-col mb-10 max-w-lg max-h-[200px] items-stretch justify-between gap-10">
...
//   return (
//     <div
//     className="relative flex h-[300px] mb-100 sm:h-[300px] w-full max-w-[320px] sm:max-w-lg items-center justify-center overflow-hidden rounded-lg border border-gray-800 bg-gray-900/30 p-4 sm:p-10 md:shadow-xl"
//     ref={containerRef}
//     >
//       <div className="flex size-full flex-col mb-10 max-w-lg max-h-[200px] items-stretch justify-between gap-10">
//         <div className="flex flex-row items-center justify-between">
...
//             <img src={modelDemo} alt="Model Demo" className="w-full h-full object-cover" />
//           </Circle> */}
          // <Circle ref={div4Ref} className="size-[68px] sm:size-[72px] p-[4px] overflow-hidden relative">
          //   <Image 
          //       src={modelDemo} 
...
const Icons = {
  ...
  office365: () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#f25022" d="M1.5 1.5h10v10h-10z"/><path fill="#7fba00" d="M12.5 1.5h10v10h-10z"/><path fill="#00a4ef" d="M1.5 12.5h10v10h-10z"/><path fill="#ffb900" d="M12.5 12.5h10v10h-10z"/></svg>
  ),
  gmail: () => (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path fill="#4285f4" d="M24 4l20 6v28l-20 6-20-6V10z"/><path fill="#ea4335" d="M4 14v20l10 3V17L4 14z"/><path fill="#34a853" d="M44 14v20l-10 3V17l10-3z"/><path fill="#fbbc05" d="M24 4v4l10 3v4l-10 3v20l-10-3V14l10-3V4z"/></svg>
  ),
  zoom: () => (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#2D8CFF" d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6.094 15.574l-4.618 2.855a1.522 1.522 0 01-1.97-.337l-2.342-2.829a.762.762 0 01-.21-.526V8.925a.763.763 0 01.975-.737l6.274 2.158c.551.19.911.715.911 1.3v4.516a1.523 1.523 0 01-1.02 1.412z"/></svg>
  ),
  cisco: () => (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#1BA0D7" d="M1.243 5.102h2.52v2.52h-2.52zm3.543-2.55H6.83v5.07H4.786zm2.22-2.796H7.88v7.867H7.006zm1.207 2.076h2.519v2.52H8.213zm3.543-1.596h2.52v4.117h-2.52zm3.564 0h2.52v4.117h-2.52zm3.543 2.196h2.52v2.52h-2.52zm3.543-2.196h2.52v2.52h-2.52z"/></svg>
  ),
  citrix: () => (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#242424"/><path fill="#FFFFFF" d="M6.692 17.23h.687c.514 0 .908-.161 1.181-.484.274-.322.411-.806.411-1.45v-6.6c0-.646-.137-1.131-.411-1.453-.273-.322-.667-.484-1.181-.484h-.687v1.397h.578v6.47h-.578v1.447zm4.188-6.018v2.157h.644v2.584h1.535v-2.584h.723v-2.157h-.723v-2.616H9.792v2.616h1.089zM17.005 17.23h-.678v-1.447h.578v-6.47h-.578V7.916h.678c.515 0 .91.162 1.182.484.273.322.41.807.41 1.453v6.6c0 .644-.137 1.128-.41 1.45-.272.323-.667.484-1.182.484z"/></svg>
  ),
  salesforce: () => (
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#00A1E0"/><path fill="#FFFFFF" d="M15.864 6.604c-.565 0-1.114.183-1.546.514-.6-.514-1.42-.777-2.264-.777-.908 0-1.754.313-2.4.891-.6-.508-1.374-.797-2.17-.797-2.103 0-3.606 2.192-3.606 4.524 0 .182.011.362.032.538C4.02 12.506 3 14.147 3 15.824 3 17.94 4.74 20 7.005 20c.72 0 1.418-.209 2.025-.589.516.373 1.127.571 1.748.571.63 0 1.254-.199 1.768-.582.607.383 1.313.591 2.03.591 2.265 0 4.005-2.061 4.005-4.176 0-1.633-.871-3.093-2.27-3.748.013-.127.019-.255.019-.384 0-2.332-1.788-4.103-3.776-4.103z"/></svg>
  ),
};
