...
//   // Add effect to handle global keydown and paste events when OTP inputs are shown
//   useEffect(() => {
//     if (!showOtpInput) return;
...
//       // On success: don't set any error, just redirect
...
//       resetOtp();
//     } finally {
//       if (error) { // Only set loading to false if there was an error
//         setLoading(false);
//       }
//     }
//   };
...
//galima pastintint ir vesti skaicius nepasirinkus langeliu.
