...
//     <div className="bg-[#050607] rounded-lg p-6 border border-gray-800">
...
//         <StatCard title="Awareness Score" value="86%" change={25} />
//         <StatCard title="Risk Exposure" value="14%" change={-25} />
//         <StatCard title="Engagement Rate" value="92%" change={5} />
//       </div>
...
//       <div className="bg-[#050607] rounded-lg p-6 border border-gray-800">
//         <h2 className="text-lg mb-4">Today's Micro Lesson</h2>
//         <p className="text-gray-400">Quick security tip: Learn to spot suspicious emails in just 5 minutes.</p>
//         <button className="mt-4 bg-blue-500/30 text-blue-400 hover:bg-blue-500/50 hover:text-blue-200 px-4 py-2 rounded-lg transition-colors">
//           Start Lesson
//         </button>
//       </div>
//     </div>
...
const CompanyDetailPanel: React.FC<CompanyDetailProps> = ({ company, isOpen, onClose }) => {
  ...
  return (
    <div className={`fixed inset-y-0 right-0 w-96 bg-[#0a0b0c] border-l border-white/[0.06] transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="mt-8">
            ...
            <div className={`p-4 rounded-lg ${
              company?.riskScore > 20 ? 'bg-red-500/10 border border-red-500/20' : 
              'bg-green-500/10 border border-green-500/20'
            }`}>
              <p className={`text-sm ${
                company?.riskScore > 20 ? 'text-red-400' : 'text-green-400'
              }`}>
