...
type GraphType = 'activity' | 'performance';
...
interface PerformanceDataStructure {
  day: PerformanceDataPoint[];
  week: PerformanceDataPoint[];
  month: PerformanceDataPoint[];
}
...
const AnalyticsComponent = () => {
  ...
  const performanceData: PerformanceDataStructure = {
    day: [
      { name: '12a', participation: 0, success: 0, application: 0 },
      { name: '6a', participation: 20, success: 15, application: 10 },
      { name: '12p', participation: 60, success: 55, application: 50 },
    ...
    <div className="rounded-lg p-4 w-full bg-transparent mx-auto">
      ...
      <div className="w-full flex justify-center mb-6">
        <div className="w-full h-80">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={graphType === 'activity' ? data[timeFrame] : performanceData[timeFrame]}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255, 255, 255, 0.1)" />
