...
// Fixed mapped type syntax by using Record utility type
type ProgressColorMap = Record<ProgressStatus, string>;
type ProgressBackgroundMap = Record<ProgressStatus, string>;
