...
const MenuOptions = () => {
  ...
  return (
    <nav className="dark:bg-black w-16 h-screen font-sans flex flex-col sticky justify-between py-6 border-r border-gray-800/20 z-[100]">
      {/* Logo */}
              ...
              <TooltipTrigger asChild>
                <Link
                  ...
                  className={cn(
                    ...
                    'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500',
                    {
                      'bg-gradient-to-b from-[#21222f]/80 to-[#21222f]/60 text-gray-200': pathName === menuItem.href,
                      'hover:bg-gradient-to-b hover:from-[#21222f]/80 hover:to-[#21222f]/60 text-gray-400 hover:text-gray-200': pathName !== menuItem.href,
                    }
                  )}
                >
                  <div className="w-7 h-7 flex items-center justify-center">
