...
const ChatUI = () => {
  ...
  return (
    <div className="min-h-screen font-sans bg-black text-gray-100 p-4 px-10">
      <div className="h-full w-full flex flex-col items-center">
        {/* Add sidebar toggle button */}
        <button 
          onClick={() => setIsSidebarOpen(true)}
          className="fixed right-4 top-4 text-gray-400 hover:text-gray-200 transition-colors"
        >
          <PanelRight size={20} />
        </button>
        ...
        {/* Input Container */}
        <div className={`w-full max-w-2xl px-4 pb-4 transition-all duration-500 ease-in-out transform
          ${isInitialState 
