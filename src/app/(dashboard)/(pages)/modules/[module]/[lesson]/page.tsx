...
// import Chat from '@/components/lessons/Chat'
...
//       return <EmailInspector moduleId={params.module as string} />
//     }
...
//       if (lesson.id === 5) { // Pakeiskite į teisingą pamokos ID iš DB
//         return <CaseStudy />
//       }

//       if (lesson.id === 6) { // Pakeiskite į teisingą pamokos ID iš DB
//         return <URLInspectorChallenge />
//       }

//       if (lesson.id === 7) { // Pakeiskite į teisingą pamokos ID iš DB
//         return <Chat />
//       }
  ...
  const renderLessonContent = () => {
    ...
    if (subLessons.length > 0) {
      ...
      switch (currentSubLesson.content_type) {
        ...
        case 'url_inspector':
          return <URLInspectorChallenge moduleId={params.module as string} onComplete={handleSubLessonComplete} />
        case 'quiz':
          lessonQuestions = questions.filter(q => q.sub_lesson_id === currentSubLesson.id)
