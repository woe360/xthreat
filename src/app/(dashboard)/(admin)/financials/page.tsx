...
const FinancialsPage = () => {
  ...
  const StatCard = ({ title, value, trend, data, color, percentageChange, prefix = '' }: StatCardProps) => (
    ...
    <div className="h-screen overflow-hidden bg-[#050607]">
      ...
      <div className="p-2 px-10">
        ...
        <div className="bg-[#181b24] border border-gray-800 rounded-lg overflow-hidden">
          <div className="p-4 border-gray-800 border-b flex justify-between items-center">
